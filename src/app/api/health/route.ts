  ...
  try {
    ...
    return NextResponse.json({
      ...
      reads: {
        ...
        committedToday: today.committed.length,
        carriedOver: today.carried.length,
        movedToday: today.movedToday.length,
        pullCandidates: Object.fromEntries(
