...
export const config = {
  matcher: [
    ...
    // api/health is excluded because it checks the same passcode itself.
    "/((?!unlock|api/health|_next/static|_next/image|icon.svg|apple-touch-icon.png|icon-192.png|icon-512.png|icon-maskable-512.png|manifest.webmanifest|favicon.ico).*)",
  ],
};
